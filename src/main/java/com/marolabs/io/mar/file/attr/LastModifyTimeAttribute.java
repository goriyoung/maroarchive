...
public class LastModifyTimeAttribute implements EntryAttribute<FileTime> {
	private FileTime time = FileTime.fromMillis(0);

	public LastModifyTimeAttribute() {
	}

	public LastModifyTimeAttribute(FileTime time) {
		if (null == time) {

...
public class CreationTimeAttribute implements EntryAttribute<FileTime> {
	private FileTime time = FileTime.fromMillis(0);

	public CreationTimeAttribute() {
	}

	public CreationTimeAttribute(FileTime time) {
		if (null == time) {
